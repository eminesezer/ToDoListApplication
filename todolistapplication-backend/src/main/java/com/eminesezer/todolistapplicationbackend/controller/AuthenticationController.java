...
import com.eminesezer.todolistapplicationbackend.exception.AuthenticationException;
import com.eminesezer.todolistapplicationbackend.model.token.TokenRequest;
import com.eminesezer.todolistapplicationbackend.model.token.TokenResponse;
...
@RestController
@CrossOrigin(origins={"http://localhost:3000","http://localhost:12800"})
public class AuthenticationController {
    ...
    public ResponseEntity<?> refreshAndGetAuthenticationToken(HttpServletRequest request) {
        ...
        UserDetailsImpl user = (UserDetailsImpl) jwtInMemoryUserDetailsService.loadUserByUsername(username);
